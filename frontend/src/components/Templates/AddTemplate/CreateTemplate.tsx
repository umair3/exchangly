...
const CreateTemplate: React.FC<ICreateTemplateProps> = (props) => {
    ...
    <div className="flex flex-col gap-2">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-base font-bold opacity-70">
          Added or saved template will be added to user defined templates
        </p>

        <p className="text-base font-bold opacity-70 my-2">Template details:</p>
        ...
        <div className="flex flex-col gap-4  rounded-lg md:shadow-gray-50 md:shadow-sm md:bg-gray-100/10 py-2 md:py-4 ">
          ...
          {!isLoading ? (
            <div className="flex py-2 px-2 items-center  gap-2 mt-4">
              <CustomButton icon="add" onClick={onAdd}>
                Create
              </CustomButton>
